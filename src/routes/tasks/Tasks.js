...
const Tasks = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col  ">
      ...
      <div className=" sm:flex sm:space-x-2 m-2 flex-1 ">
        <div className="mb-2 sm:mb-0 sm:w-1/3  h-1/3 sm:h-auto bg-stone-200 rounded-t shadow overflow-y-scroll scrollbar-hide">
