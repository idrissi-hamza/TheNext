...
function Sidebar() {
  ...
  return (
    ...
    <>
      {sidebar && (
        <aside className=" hidden sm:inline-block h-full text-gray-700 px-2 bg-neutral-200 shadow-sm shrink-0 relative">
          <button
      ...
      {!sidebar && (
        <aside className=" h-full text-gray-700 px-4 bg-neutral-200 shrink-0 relative">
          <button
